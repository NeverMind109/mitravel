...
var featuredVideos = document.querySelector(".slider-container");
var heroMedia = document.querySelector(".swiper-container");
var heroPlay = document.querySelectorAll(".main-slider__play");
heroPlay.forEach(function (el) {
...
var featuredVideosSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](featuredVideos, {
  loop: true,
  centeredSlides: true,
  spaceBetween: 50,
...
var heroMediaSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](heroMedia, {
  loop: true,
  spaceBetween: 0,
  slidesPerView: 1,
  navigation: {
...
heroMediaSlider.on("transitionEnd", function () {
  var videos = document.querySelectorAll(".hero__slider video");
...
(function () {
  ...
  var menuItems = document.querySelectorAll("[data-menu-item]"); // const overlay = document.querySelector("[data-menu-overlay]");
